...
| `9630000001`–`9630000002` | `SluWeeklySnapshotRepositoryIT` |
| `9640000001`–`9640000002` | `StripeCustomerRepositoryIT` |
| `9650000001`–`9650000010` | `CoachRadarPreferencePlayerFkIT` |
| `9651000001`–`9651000005` | `SkillDefinitionResourceIT` |
| `9652000001`–`9652000009` | `SluSkillTrendIT` |
...
`9500`, `9511`, `9540`, `9550`, `9560`, `9570`, `9580`, `9590`, `9600`, `9610`, `9611`, `9620`, `9630`,
`9640`, `9650`, `9651`, `9652`, `9700`, `9800`, `9810`, `9820`, `9830`, `9900`.

**Free blocks** for new classes: `9310`–`9350`, `9370`–`9390`, `9400`–`9490`, `9520`–`9530`,
`9653`–`9690`, `9710`–`9790`, `9840`–`9890`, `9910`–`9990`.
