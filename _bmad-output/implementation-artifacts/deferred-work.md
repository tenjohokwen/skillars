...
- Lock-ordering safety across the three coach-profile-lock-acquiring methods (`RescheduleService
  ...
  order, would deadlock silently with nothing today to prevent or detect it. Deferred: broad architectural
...
- `BookingService.isSlotWithinAvailabilityWindow`'s new all-invalid-timezone summary WARN reads
  ...
  [`src/main/java/com/softropic/skillars/platform/booking/service/BookingService.java`] `[PICKED UP by skillars-deferred-60 AC1]`
