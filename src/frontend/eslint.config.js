...
export default [
  {
     ...
     */
    // skillars-deferred-104: `coverage/` is generated by `npm run test:unit:ci`
    // (@vitest/coverage-v8). Its emitted helper scripts carry their own eslint-disable
    // directives that trip `--report-unused-disable-directives`; it is build output, not source.
    ignores: ['coverage/'],
  },
