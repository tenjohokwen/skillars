<template>
  <q-page class="coach-profile-page q-pa-md">
    ...
    <div v-else-if="notFound" class="flex flex-center column q-gutter-md" style="min-height: 60vh">
      ...
      <div class="text-h6" style="color: var(--text-primary)">{{ t('marketplace.coachNotFound') }}</div>
      <q-btn flat :label="t('marketplace.backToMarketplace')" icon="arrow_back" @click="router.push('/marketplace')" />
    </div>
    ...
    <div v-else-if="profile" class="row q-col-gutter-lg">
      ...
      <div class="col-12 col-md-8">
          ...
          <div class="col">
            ...
            <div class="row items-center q-gutter-sm q-mt-xs">
              ...
              <q-chip
                ...
                size="sm"
              >
                {{ profile.available ? t('marketplace.availabilityStatus.available') : t('marketplace.availabilityStatus.unavailable') }}
              </q-chip>
            </div>
          </div>
        </div>
        ...
        <div v-if="profile.bio" class="glass-card q-pa-md q-mb-md">
          <div class="text-body1" style="color: var(--text-primary); white-space: pre-wrap">{{ profile.bio }}</div>
        </div>
      ...
      <div class="col-12 col-md-4">
        <div class="glass-card q-pa-md">
          <!-- Hero price -->
          <div v-if="profile.perSessionPrice" class="text-h4 text-weight-bold q-mb-md" style="color: var(--text-primary)">
