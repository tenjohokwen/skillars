export default {
  auth: {
    ...
    coach: {
      ...
      step3SessionDuration: 'Session Length',
      step3SessionDurationDefault: 'Use platform default (60 min)',
    ...
    parent: {
      ...
      resendOtp: 'Resend Code',
      contactDetailWarning: 'Contact details will be removed on save',
      dashboardTitle: 'Welcome to Skillars',
      dashboardBody: 'Manage your players and their coaching sessions here.',
      playersTitle: 'Your Players',
      addPlayerCta: 'Add another player',
      quickLinksTitle: 'Quick Links',
      upcomingSessionsTitle: 'Upcoming Sessions',
      upcomingSessionsCount: '{count} upcoming',
      browseCoachesTitle: 'Browse Coaches',
      browseCoachesBody: 'Find a coach for your player',
      creditWalletTitle: 'Credit Wallet',
      approvalsTitle: 'Pending Approvals',
      approvalsPending: '{count} awaiting your review',
  ...
  reviews: {
    ...
    validationError: 'Please check your review and try again.',
  },
  session: {
  ...
  booking: {
    requests: {
      ...
      ownBookingCaption: 'You have already requested this slot',
