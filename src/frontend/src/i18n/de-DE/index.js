export default {
  ...
  auth: {
    ...
    parent: {
      ...
      dashboardBody: 'Verwalte hier deine Spieler und ihre Trainingseinheiten.',
      ...
      browseCoachesBody: 'Finde einen Trainer für dein Kind',
      creditWalletTitle: 'Guthabenkonto',
      approvalsTitle: 'Ausstehende Freigaben',
      approvalsPending: '{count} warten auf deine Prüfung',
  ...
  booking: {
    requests: {
      ...
      ownBookingCaption: 'Du hast dieses Zeitfenster bereits angefragt',
