export default {
  ...
  payment: {
    ...
    sessionPack: {
      ...
      expired: 'This session pack expired on {date}. Contact your coach if an extension is possible.',
  ...
  revenue: {
    ...
    stripeFeeNote: 'Stripe fees are estimated at the summary level. Per-transaction net is before fee deduction.',
    receipt: {
