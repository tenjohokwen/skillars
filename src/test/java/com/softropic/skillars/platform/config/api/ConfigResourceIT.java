...
class ConfigResourceIT extends AbstractIntegrationTest {
     ...
     * of the 4 {@code HAS_CODE_DEFAULT} keys {@code V139__baseline_seed_data.sql} never seeded
     * (story-review.md B2's corrected count). This exercises the real explicit-id insert against
